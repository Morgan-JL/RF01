...
import com.fs.web.servlet.LuckyDispatcherServlet;
...
public class LuckyDispatcherServletInitializer implements WebApplicationInitializer{
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        log.info("WebApplicationInitialize Add Servlet `name = LuckyDispatcherServlet mapping = [/] class = LuckyDispatcherServlet`");
    }
}
