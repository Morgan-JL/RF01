...
import com.fs.web.exception.AddMappingExpandException;
import com.fs.web.mapping.DefaultMappingAnalysis;
import com.fs.web.mapping.ExceptionMappingCollection;
...
import com.fs.framework.container.SingletonContainer;
import com.fs.framework.scan.JarExpand;
import com.fs.framework.scan.LuckyURLClassLoader;
...
public abstract class JarExpandController extends LuckyController{
    ...
    protected void uploadJar(MultipartFile jar, String expandName, String groupId) throws IOException {
        ...
        if(Assert.isNull(expandName)){
            throw new AddMappingExpandException("扩展名`expandName`为NULL！");
        }
