package com.fs.utils.conversion.proxy;

import com.fs.utils.conversion.EntityAndDto;
import com.fs.utils.conversion.annotation.Mapping;
import com.fs.utils.conversion.annotation.Mappings;
...
public class EDProxy extends Conversion {
    ...
    public static <T extends LuckyConversion> T getProxy(Class<T> childInterfaceClass){
        ...
        Class<? extends LuckyConversion>[] luckyConversionClasses=childInterfaceClass.getAnnotation(
            com.fs.utils.conversion.annotation.Conversion.class).value();
